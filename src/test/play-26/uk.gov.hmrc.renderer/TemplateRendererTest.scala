...
class TemplateRendererTest extends FlatSpec with Matchers with GuiceOneAppPerSuite {

  val request = FakeRequest()
  implicit lazy val messages = app.injector.instanceOf[MessagesApi].preferred(request)
